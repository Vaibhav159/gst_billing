...
class LineItemAdmin(admin.ModelAdmin):
    list_display = ('customer', 'product_name', 'hsn_code', 'quantity', 'rate', 'cgst', 'sgst', 'amount')
    list_filter = ('customer', 'product_name', 'hsn_code', 'quantity', 'rate', 'cgst', 'sgst', 'amount')
    search_fields = ('customer', 'product_name', 'hsn_code', 'quantity', 'rate', 'cgst', 'sgst', 'amount')
    ordering = ('customer', 'product_name', 'hsn_code', 'quantity', 'rate', 'cgst', 'sgst', 'amount')
