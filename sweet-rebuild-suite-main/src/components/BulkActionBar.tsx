    ...
    <AnimatePresence>
      {selectedCount > 0 && (
        <motion.div
          ...
          className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 px-5 py-3 rounded-2xl elevated-card border border-primary/20 shadow-2xl safe-area-bottom"
        >
