...
import EasyMoreDrawer from "./EasyMoreDrawer";
...
export default function EasyBottomNav() {
  ...
  const moreActive = ["/billing/settings"].some((p) => location.pathname.startsWith(p));
  ...
  return (
    <>
      ...
      <EasyMoreDrawer open={moreOpen} onOpenChange={setMoreOpen} />
    </>
  );
}
